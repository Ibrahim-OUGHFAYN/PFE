...
const {getAvisByAuthenticatedGuide,deleteAvis} = require("../controllers/Avis.controller")
...
router.get("/avis",authMiddleware,getAvisByAuthenticatedGuide)
router.get("/avis/:avisId",authMiddleware,deleteAvis)
